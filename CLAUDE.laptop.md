...
- On this laptop, `C:\Users\RobertCarucci` is the real profile; `C:\Users\carucci_r` is a junction pointing to it. If a path looks wrong, verify junction status and `get_onedrive_root()` before editing files.
